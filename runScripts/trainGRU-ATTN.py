# Script to initiate training process of the GRU Cell Based network with attention enabled.


print("GRU Network training process initiated with attention enabled...")
...
checkpointSys = checkpoint.checkpointSys('simple', 'gru', 'Attention')
...
gru_net = gruSimple.GruSimple(docSum_file, checkpointSys, attention=True)
